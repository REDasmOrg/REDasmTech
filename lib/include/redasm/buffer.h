...
REDASM_EXPORT usize rdbuffer_read(const RDBuffer* self, usize idx, void* dst, usize n);
REDASM_EXPORT RDValueOpt rdbuffer_readstruct_n(const RDBuffer* self, usize idx, usize n, const RDStructFieldDecl* fields);
REDASM_EXPORT RDValueOpt rdbuffer_readstruct( const RDBuffer* self, usize idx, const RDStructFieldDecl* fields);
REDASM_EXPORT bool rdbuffer_getmbyte(const RDBuffer* self, usize idx, RDMByte* v);
...
REDASM_EXPORT bool rdbuffer_getwstr(const RDBuffer* self, usize idx, usize n, const char** v);
REDASM_EXPORT RDValueOpt rdbuffer_gettypename(const RDBuffer* self, usize idx, const char* tname);
REDASM_EXPORT RDValueOpt rdbuffer_gettype(const RDBuffer* self, usize idx, const RDType* t);
