...
const RDILExpr* rdil_add(RDILPool* self, const RDILExpr* l,
                               const RDILExpr* r) {
    return redasm::api::internal::rdilpool_add(self, l, r);
}

const RDILExpr* rdil_sub(RDILPool* self, const RDILExpr* l,
                               const RDILExpr* r) {
    return redasm::api::internal::rdilpool_sub(self, l, r);
}

const RDILExpr* rdil_mul(RDILPool* self, const RDILExpr* l,
                               const RDILExpr* r) {
    return redasm::api::internal::rdilpool_mul(self, l, r);
}

const RDILExpr* rdil_div(RDILPool* self, const RDILExpr* l,
                               const RDILExpr* r) {
    return redasm::api::internal::rdilpool_div(self, l, r);
}

const RDILExpr* rdil_mod(RDILPool* self, const RDILExpr* l,
                               const RDILExpr* r) {
    return redasm::api::internal::rdilpool_mod(self, l, r);
}

const RDILExpr* rdil_and(RDILPool* self, const RDILExpr* l,
                               const RDILExpr* r) {
    return redasm::api::internal::rdilpool_and(self, l, r);
}

const RDILExpr* rdil_or(RDILPool* self, const RDILExpr* l,
                              const RDILExpr* r) {
    return redasm::api::internal::rdilpool_or(self, l, r);
}

const RDILExpr* rdil_xor(RDILPool* self, const RDILExpr* l,
                               const RDILExpr* r) {
    return redasm::api::internal::rdilpool_xor(self, l, r);
}

const RDILExpr* rdil_lsl(RDILPool* self, const RDILExpr* l,
                               const RDILExpr* r) {
    return redasm::api::internal::rdilpool_lsl(self, l, r);
}

const RDILExpr* rdil_lsr(RDILPool* self, const RDILExpr* l,
                               const RDILExpr* r) {
    return redasm::api::internal::rdilpool_lsr(self, l, r);
}

const RDILExpr* rdil_asl(RDILPool* self, const RDILExpr* l,
                               const RDILExpr* r) {
    return redasm::api::internal::rdilpool_asl(self, l, r);
}

const RDILExpr* rdil_asr(RDILPool* self, const RDILExpr* l,
                               const RDILExpr* r) {
    return redasm::api::internal::rdilpool_asr(self, l, r);
}

const RDILExpr* rdil_rol(RDILPool* self, const RDILExpr* l,
                               const RDILExpr* r) {
    return redasm::api::internal::rdilpool_rol(self, l, r);
}

const RDILExpr* rdil_ror(RDILPool* self, const RDILExpr* l,
                               const RDILExpr* r) {
...
const RDILExpr* rdil_if(RDILPool* self, const RDILExpr* cond,
                              const RDILExpr* t,
                              const RDILExpr* f) {
    return redasm::api::internal::rdilpool_if(self, cond, t, f);
}

const RDILExpr* rdil_eq(RDILPool* self, const RDILExpr* l,
                              const RDILExpr* r) {
    return redasm::api::internal::rdilpool_eq(self, l, r);
}

const RDILExpr* rdil_ne(RDILPool* self, const RDILExpr* l,
                              const RDILExpr* r) {
    return redasm::api::internal::rdilpool_ne(self, l, r);
}

const RDILExpr* rdil_lt(RDILPool* self, const RDILExpr* l,
                              const RDILExpr* r) {
    return redasm::api::internal::rdilpool_lt(self, l, r);
}

const RDILExpr* rdil_le(RDILPool* self, const RDILExpr* l,
                              const RDILExpr* r) {
    return redasm::api::internal::rdilpool_le(self, l, r);
}

const RDILExpr* rdil_gt(RDILPool* self, const RDILExpr* l,
                              const RDILExpr* r) {
    return redasm::api::internal::rdilpool_gt(self, l, r);
}

const RDILExpr* rdil_ge(RDILPool* self, const RDILExpr* l,
                              const RDILExpr* r) {
