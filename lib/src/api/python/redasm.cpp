...
PyObject* set_export(PyObject* /*self*/, PyObject* args) {
    ...
    return internal::set_export(address, name) ? Py_True : Py_False;
}
...
PyObject* set_import(PyObject* /*self*/, PyObject* args) {
    ...
    return internal::set_import(address, name) ? Py_True : Py_False;
}
...
PyObject* register_processor(PyObject* /*self*/, PyObject* args,
    ...
    processor.emulate = [](const RDProcessor* self, RDEmulateResult* r) {
