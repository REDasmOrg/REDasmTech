...
inline PyMethodDef methods[] = {
    ...
    {"set_export", python::set_export, METH_VARARGS, nullptr},
    {"set_import", python::set_import, METH_VARARGS, nullptr},
    {"set_function", python::set_function, METH_VARARGS, nullptr},
