...
const RDStructFieldDecl ELF_PHDR_64BE[] = {
...
// const RDStructFieldDecl ELF_SHDR_32LE[] = {
...
// const RDStructFieldDecl ELF_SHDR_64LE[] = {
...
// const RDStructFieldDecl ELF_SHDR_32BE[] = {
...
// const RDStructFieldDecl ELF_SHDR_64BE[] = {
...
const RDStructFieldDecl ELF_DYN_32LE[] = {
    {"i32", "d_tag"}, {"u32", "d_val"}, {nullptr, nullptr}};

const RDStructFieldDecl ELF_DYN_64LE[] = {
    {"i64", "d_tag"}, {"u64", "d_val"}, {nullptr, nullptr}};

const RDStructFieldDecl ELF_DYN_32BE[] = {
    {"i32be", "d_tag"}, {"u32be", "d_val"}, {nullptr, nullptr}};

const RDStructFieldDecl ELF_DYN_64BE[] = {
    {"i64be", "d_tag"}, {"u64be", "d_val"}, {nullptr, nullptr}};

const RDStructFieldDecl ELF_SYM_32LE[] = {
    {"u32", "st_name"}, {"u32", "st_value"}, {"u32", "st_size"},
    {"u8", "st_info"},  {"u8", "st_other"},  {"u16", "st_shndx"},
    {nullptr, nullptr},
};

const RDStructFieldDecl ELF_SYM_32BE[] = {
    {"u32be", "st_name"}, {"u32be", "st_value"}, {"u32be", "st_size"},
    {"u8", "st_info"},    {"u8", "st_other"},    {"u16be", "st_shndx"},
    {nullptr, nullptr},
};

const RDStructFieldDecl ELF_SYM_64LE[] = {
    {"u32", "st_name"},  {"u8", "st_info"},   {"u8", "st_other"},
    {"u16", "st_shndx"}, {"u64", "st_value"}, {"u64", "st_size"},
    {nullptr, nullptr},
};

const RDStructFieldDecl ELF_SYM_64BE[] = {
    {"u32be", "st_name"},  {"u8", "st_info"},     {"u8", "st_other"},
    {"u16be", "st_shndx"}, {"u64be", "st_value"}, {"u64be", "st_size"},
    {nullptr, nullptr},
};

const RDStructFieldDecl ELF_REL_32LE[] = {
    {"u32", "r_offset"}, {"u32", "r_info"}, {nullptr, nullptr}};

const RDStructFieldDecl ELF_REL_64LE[] = {
    {"u64", "r_offset"}, {"u64", "r_info"}, {nullptr, nullptr}};

const RDStructFieldDecl ELF_REL_32BE[] = {
    {"u32be", "r_offset"}, {"u32be", "r_info"}, {nullptr, nullptr}};

const RDStructFieldDecl ELF_REL_64BE[] = {
    {"u64be", "r_offset"}, {"u64be", "r_info"}, {nullptr, nullptr}};

const RDStructFieldDecl ELF_RELA_32LE[] = {{"u32", "r_offset"},
                                           {"u32", "r_info"},
                                           {"i32", "r_addend"},
                                           {nullptr, nullptr}};

const RDStructFieldDecl ELF_RELA_64LE[] = {{"u64", "r_offset"},
                                           {"u64", "r_info"},
                                           {"i64", "r_addend"},
                                           {nullptr, nullptr}};

const RDStructFieldDecl ELF_RELA_32BE[] = {{"u32be", "r_offset"},
                                           {"u32be", "r_info"},
                                           {"i32be", "r_addend"},
                                           {nullptr, nullptr}};

const RDStructFieldDecl ELF_RELA_64BE[] = {{"u64be", "r_offset"},
                                           {"u64be", "r_info"},
                                           {"i64be", "r_addend"},
                                           {nullptr, nullptr}};

const RDStructFieldDecl ELF_VERNEED_LE[] = {
    {"u16", "vn_version"}, {"u16", "vn_cnt"},  {"u32", "vn_file"},
    {"u32", "vn_aux"},     {"u32", "vn_next"}, {nullptr, nullptr}};

const RDStructFieldDecl ELF_VERNEED_BE[] = {
...
void register_all(const ElfIdent& ident) {
    ...
    if(isbe) {
        ...
        // // rd_createstruct("ELF_SHDR", b == 64 ? ELF_SHDR_64BE :
        // ELF_SHDR_32BE);
        ...
        // rd_createstruct("ELF_SHDR", b == 64 ? ELF_SHDR_64LE :
        // ELF_SHDR_32LE);
